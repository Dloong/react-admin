...
api.registerModel(model);api.addLocales({'zh-CN':zhCN,'en-US':enUS});var FormattedMessage=api.intl.FormattedMessage;var commonContent=[React$1__default.createElement("a",{onClick:function onClick(){return api.redirect('/tasks?type=block&active=build&iife=true');}},React$1__default.createElement(FormattedMessage,{id:"org.umi.ui.tasks.dashboard.build"})),React$1__default.createElement("a",{onClick:function onClick(){return api.redirect('/tasks?type=block&active=lint&iife=true');}},React$1__default.createElement(FormattedMessage,{id:"org.umi.ui.tasks.dashboard.lint"}))];api.addDashboard({// 唯一标识，org.umi.dashboard.card.${key}
key:'org.umi.dashboard.card.task',title:React$1__default.createElement(FormattedMessage,{id:"org.umi.ui.tasks.title"}),description:React$1__default.createElement(FormattedMessage,{id:"org.umi.ui.tasks.description"}),icon:React$1__default.createElement(Setting,null),content:api.mini?// mini 下没有 dev
commonContent:[React$1__default.createElement("a",{onClick:function onClick(){return api.redirect('/tasks?type=block&active=dev&iife=true');}},React$1__default.createElement(FormattedMessage,{id:"org.umi.ui.tasks.dashboard.dev"}))].concat(commonContent)});api.addPanel({title:'org.umi.ui.tasks.title',path:'/tasks',icon:{type:'project',theme:'filled'},component:api.connect(function(state){return{taskManager:state[model.namespace]};})(TasksView)});};return ui;});