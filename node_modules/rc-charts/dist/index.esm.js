...
import { Chart, Tooltip, Coord, Legend, Geom, Label, Axis, Shape, Util, View } from 'bizcharts';
...
var PieChart = function PieChart(props) {
  ...
  return React.createElement("div", {
  ...
  }), React.createElement(Legend, Object.assign({}, legend)), React.createElement(Geom, {
    style: {
      lineWidth: lineWidth,
      stroke: '#fff'
    },
    ...
    selected: selected
  }, showLabel && React.createElement(Label, Object.assign({
    content: 'percent'
...
var LineChart = function LineChart(props) {
  ...
  var data = isArray(sourceData) ? sourceData : [];
  React.useEffect(function () {
  ...
  return React.createElement("div", {
    ...
    style: style
  }, title && React.createElement("h4", null, title), React.createElement(Chart, {
    height: height,
    padding: padding,
    data: chartData,
    scale: cols,
    ...
    key: "axis-y",
    name: "value"
  }), React.createElement(Tooltip, null), React.createElement(Legend, Object.assign({
    position: "top"
  }, legend)), React.createElement(Geom, {
    type: "line",
    position: "x*value",
    size: borderWidth,
...
var BarChart = function BarChart(props) {
  ...
  return React.createElement("div", {
    ...
    scale: scale,
    forceFit: true
  }, !mini && React.createElement(Axis, Object.assign({
    key: "axis-x",
    name: "x"
  }, xAxis)), !mini && React.createElement(Axis, Object.assign({
    key: "axis-y",
    name: "value"
  }, yAxis)), !mini && React.createElement(Legend, Object.assign({
    name: "key",
    position: "top"
  }, legend)), React.createElement(Coord, {
    transpose: direction === 'horizontal'
  }), React.createElement(Tooltip, Object.assign({}, tooltip)), React.createElement(Geom, {
    type: type,
    position: "x*value",
    color: colors ? ['key', colors] : 'key',
    size: borderWidth ? borderWidth : undefined
  }, showLabel && type === 'interval' && React.createElement(Label, Object.assign({
...
var AreaChart = function AreaChart(props) {
  ...
  return React.createElement("div", {
    ...
    name: "value",
    title: true
  }, yAxis)), !mini && React.createElement(Legend, Object.assign({}, legend)), React.createElement(Tooltip, Object.assign({}, tooltip)), React.createElement(Geom, {
    ...
    color: colors && colors.length ? ['key', colors] : 'key',
    shape: smooth ? 'smooth' : ''
  }), point && React.createElement(Geom, {
    type: "point",
    position: "x*value",
    size: 4,
    shape: "circle",
...
var Calendar = function Calendar(props) {
  ...
  return React.createElement("div", null, React.createElement(Chart, {
    ...
    title: 'date'
  }), React.createElement(Axis, Object.assign({
    name: "week",
    position: "bottom",
    tickLine: null,
    line: null,
  ...
  }, weekAxis)), React.createElement(Axis, Object.assign({
    name: 'day'
  }, dayAxis)), React.createElement(Geom, {
    type: "polygon",
...
var RadarChart = function RadarChart(props) {
  ...
  return React.createElement("div", {
    ...
    type: "polar",
    radius: radius
  }), React.createElement(Tooltip, null), React.createElement(Legend, null), React.createElement(Axis, Object.assign({
    key: "axis-x",
    name: 'x',
    line: null,
    tickLine: null,
  ...
  }, xAxis)), React.createElement(Axis, Object.assign({
    key: "axis-y",
    name: 'value',
    line: null,
    tickLine: null,
  ...
  }, yAxis)), React.createElement(Geom, {
    type: 'line',
    position: 'x*value',
    size: borderWidth,
    ...
    shape: 'circle',
    color: colors.length ? ['key', colors] : 'key'
  }), areas ? React.createElement(Geom, {
    type: 'area',
    position: 'x*value',
    color: colors.length ? ['key', colors] : 'key'
  }) : ''));
...
var BoxChart = function BoxChart(props) {
  ...
  return React.createElement("div", {
    ...
    key: "axis-y",
    name: "value"
  }, yAxis)), React.createElement(Tooltip, Object.assign({}, tooltip)), React.createElement(Legend, Object.assign({}, legend)), React.createElement(Geom, {
    type: "schema",
    position: "key*bin",
    size: borderWidth,
    ...
    shape: "box",
    adjust: "dodge"
  }), outliersFlag ? React.createElement(View, {
    data: data
  }, React.createElement(Geom, {
    type: 'point',
...
export { AreaChart as Area, BarChart as Bar, BoxChart as Box, Calendar, LineChart as Line, PieChart as Pie, RadarChart as Radar };
